...
4. **k150 终值(400/400 毕)**: min floor=0.0005452568894197198(自264轨未变) → k_c=0.2121985434937187【终】。
   **闸终裁**: 六点幂律外推 k_c(150)=0.2166702071, 实测偏差 −2.0638%, 远超 ±0.05% 闸 → **出闸【终判·否证接口触发】**: 单幂律全程性否证【退】。
   七点重拟: α=−0.7251277864, c=2.0873352888, γ=−0.1051114577; 分段α末两段加速(−0.725→−0.754)。
   γ 双栈同号为负(我七点−0.105111 vs lgt六点−0.090432): 负弯曲方向【立·结构】, 量值差16%【冲·未合】。
5b. k150 floors 全谱: outbox/kc_floors_sevengrid.json(七终格400×7)。
5. floors 全谱数据件: vci-usrm/outbox/kc_floors_sevengrid.json(七终格 400×7 全阵列, 供逐点复算; v1六格件留存档)。
